                    ...
                    <div className="wrapper">
                        ...
                        <div className="navbar">
                            ...
                            <div className="navbar-content">
                                ...
                                <div className="navbar-admin-name">
                                    <button className="admin-name-btn" onClick={()=> this.logout()}>
                        ...
                        
                        {
                            ...
                            <div className="logout-dropdown">
                                        ...
                                        <div className="notify-item">
                                            <button className="logout-btn" onClick={()=> this.props.logoutNow()}>Logout</button>
                                        </div>
                                        <div className="notify-item">
                                            <NavLink className="logout-btn settings-btn" to="/settings">Settings</NavLink>
                                        </div>
                            </div>
                            : null
                        }
...
export default connect(null, {logoutNow})(index)
